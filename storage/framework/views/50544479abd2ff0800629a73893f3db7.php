<?php $__env->startSection('content'); ?>
    <div class="container mt-4">
        ...
        <div  class="table-responsive border p-3 rounded-3">
            <table id="example" class="table table-bordered table-hover table-striped mb-0 bg-white">
                <thead>
                    <tr>
                        <th>First Name</th>
                        <th>Last Name</th>
...
<?php echo $__env->make('layouts.app-home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel materi\modul-8\resources\views/employee/index.blade.php ENDPATH**/ ?>